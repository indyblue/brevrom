    ...
    Const voyelles = "aæeëioœuyáéíóúýÁÉËÍÓÚÝÆŒ"
	 Const ForReading = 1, ForAppending = 8
'    Const Marque_Accent = " " ' marque l'accent placé dans le mot pour déboguer
...
'        End If
    ...
    End Sub
    Sub Cas_General()
        ' Repérage des accentuation basées sur une règle Generale
        '    Radical = "[]" + Radical
        '    Suffixe = Suffixe + "()"
    End Sub
    ...
    Function decouper_voyelle()
        ...
        ElseIf curseur > 1 Then  ' test de voyelles composées : au, ae, oe (pas ë ! )
            ...
            End If
        End If
        '   Cas General : pas de voyelle double, on prend la dernière lettre
    ...
    Sub Accentuer_mot_courant() 'aæeëioœuyáéíóúýÁÉËÍÓÚÝÆŒ
    ...
    Sub diphtongue()
        Dim pref 'aæeëioœuyáéíóúýÁÉËÍÓÚÝÆŒ
    ...
    End Sub
    Sub type_B()
        '   La voyelle qui précède un "b" est Generalement longue.
        '
        If Suffixe = "unt" Then
            Penultieme()
            Cas_General()
    ...
    Sub type_C()
        ...
        If (Right(MoT, 3) = "tri") Then
            ...
            Cas_General()
        ElseIf Voyelle_2 = "a" Then
            type_A() '    Generalement pénultième, quelques exceptions centralisées sur "A"
    ...
    End Sub
    Sub type_L()
        '   La voyelle devant le L est Generalement faible, => majoritairement antépénultième
    ...
    Sub type_M()
        If Voyelle_2 = "a" Then
            ...
            ' cas des ..im.. Generalement antépénultièmes
    ...
    Sub Type_R()
        ...
        If Voyelle_2 = "a" Then
            type_A() '    quelques exceptions centralisées sur "A"
            ' Generalement les -ir, -or, -ur,  -yr, sont accentués, mais il y a quelques exceptions :
    ...
    Sub Cas_Exotique()
        ...
        ' Generalement des noms hébreux (attention : TH traité avec T)
        MoT = MoT & Consonnes_2
