...
var Hyphenator = (function () {
	...
	isBookmarklet = (function () {
		...
		for (i = 0, l = jsArray.length; i < l; i++) {
			...
			if (!loc) {
				continue;
			} else if (loc.indexOf('HyphenatorP.js?bm=true') !== -1) {
				re = true;
			}
		}
		return re;
	...
	*/
	...
	hyphenateWord = function (lang, word) {
		var lo = Hyphenator.languages[lang],
			parts, i, l, w, wl, s, hypos, p, maxwins, win, pat = false, patk, patl, c, digits, z, numb3rs, n, inserted, hyphenatedword, pats;
		if (word === '') {
			return '';
		}
		...
		return hyphenatedword.concat(pats);
	},
