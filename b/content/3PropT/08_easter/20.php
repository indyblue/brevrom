<?php 
	...
	head_temp(2,'Dominica II post Pascha', 'Second Sunday after Easter');
	...
	ant('PrTemp/easter/20b.php','B');
	rubrics('head/Prayer.php');
	prayer('PrTemp/easter/20.php');
	space();
	...
	hymn('ad_regias_agni_dapes.php',1);
	vrS('PrTemp/mane_nobiscum_domine.php',1);
	ant('PrTemp/easter/20m2.php','M');
	rubrics('head/Prayer.php');
	prayer('PrTemp/easter/20.php');
	space();

	feria(2,4);
	ant('PrTemp/easter/22b.php','B');
	ant('PrTemp/easter/22m.php','M');
	space();

	feria(3,4);
	ant('PrTemp/easter/23b.php','B');
	ant('PrTemp/easter/23m.php','M');
	space();

	feria(4,4);
	ant('PrTemp/easter/24b.php','B');
	ant('PrTemp/easter/24m.php','M');
	space();

	feria(5,4);
	ant('PrTemp/easter/25b.php','B');
	ant('PrTemp/easter/25m.php','M');
	space();

	feria(6,4);
	ant('PrTemp/easter/26b.php','B');
	ant('PrTemp/easter/26m.php','M');
	space();
