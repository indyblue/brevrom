<?php
	...
	bookmark('orNone');
	hour('N','O');
	rubp('<snr>41</s> Nona absolute incipitur versu:',
		'<snr>41</s> None always begins with this verse:');
...
Saturday (<snr>'. bkref('psSN') .'</s>).');
	...
	rubp('<snr>44</s> Repetita post ultimum psalmum antiphona, subditur capitulum et responsorium breve, prouti Officium occurrens requirit.',
		'<snr>44</s> After the antiphon is repeated after the last psalm, the little chapter and brief response are said, according to the Office of the day.');
	
	head('De oratione','The Collect',2);
	rubp('<snr>45</s> Expleto responsorio brevi, statim dicitur:',
		'<snr>45</s> After the brief response, the following is said immediately:');
	vr('dv_de_LV.php');
	vr('oremus.php');
	...
	rubp('<snr>46</s> Post ultimam orationem additur:',
		'<snr>46</s> After the last prayer is added:');
	vr('dv_de_short.php');
