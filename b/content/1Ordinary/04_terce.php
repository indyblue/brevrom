<?php
	...
	bookmark('orTerce');
	hour('T','O');
	rubp('<snr>29</s> Tertia absolute incipitur versu:', '<snr>29</s> Terce always begins with this verse:');
	vr('deus_in_adjutorium.php');

	rubp('<snr>30</s> De hymno','<snr>30</s> The hymn',1);
	hymn('nunc_sancte_nobis_spiritus.php');
	rubp('<snr>¶</s> In festo Pentecostes et per octavam, loco præcedentis, dicitur hymnus <snr>Veni, Creátor Spíritus</s>, <snr>p. '. bkref('veni_creator_spiritus') . '</s>.', '<snr>¶</s> On the feast of Pentecost and during the octave, in place of the preceding, recite the hymn <snr>Veni, Creátor Spíritus</s>, <snr>p. '. bkref('veni_creator_spiritus') . '</s>.');
	...
	rubp('<snr>32</s> Repetita post ultimum psalmum antiphona, subditur capitulum et responsorium breve, prouti Officium occurrens requirit.', '<snr>32</s> After the antiphon is repeated after the last psalm, the little chapter and brief response are said, according to the Office of the day.');
	...
	rubp('<snr>34</s> Post ultimam orationem additur:', '<snr>34</s> After the last prayer is added:');
	vr('dv_de_short.php');
