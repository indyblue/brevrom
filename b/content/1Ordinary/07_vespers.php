<?php
	...
	bookmark('orVespers');
	hour('V','O');
	rubp('<snr>47</s> Vesperæ absolute incipiuntur versu:',
		'<snr>47</s> Vespers always begins with this verse:');
	vr('deus_in_adjutorium.php');

	head('De antiphonis et psalmis','Antiphons and psalms',2);
	rubp('<snr>48</s> Deinde sub congruentibus antiphonis dicuntur psalmi et canticum, prouti Officium occurrens requirit.',
		'<snr>48</s> Then with the corresponding antiphons, the psalms and canticle are said, according to the Office of the day.');
...
Saturday (<snr>'. bkref('psSV') .'</s>).');
	...
	rubp('<snr>49</s> Repetita antiphona post ultimum psalmum, dicitur capitulum, hymnus et versus, prouti Officium occurrens requirit.',
		'<snr>49</s> After Repeating the antiphon after the last psalm, recite the little chapter, hymn and versicle, according to the Office of the day.');

	head('De cantico <snr>Magníficat</s>','The canticle <snr>Magníficat</s>',2);
	rubp('<snr>50</s> Recitato versu, dicitur cum antiphona convenienti sequens:',
	...
	rubp('<snr>51</s> Quando, juxta rubricas (n. 260), preces sunt dicendæ post repetitam antiphonam ad <snr>Benedíctus</s>, dicitur, flexis genibus.',
		'<snr>51</s> When, according to the rubrics (n. 260), the preces are to be said, after the antiphon at the <snr>Benedíctus</s> is repeated , say the Preces, while kneeling.');
	...
	rubp('<snr>53</s> Post ultimam orationem additur:',
		'<snr>53</s> After the last prayer is added:');
	vr('dv_de_short.php');
