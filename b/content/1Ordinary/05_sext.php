<?php
	...
	bookmark('orSext');
	hour('S','O');
	rubp('<snr>35</s> Sexta absolute incipitur versu:', '<snr>35</s> Sext always begins with this verse:');
	...
	rubp('<snr>38</s> Repetita post ultimum psalmum antiphona, subditur capitulum et responsorium breve, prouti Officium occurrens requirit.', '<snr>38</s> After the antiphon is repeated after the last psalm, the little chapter and brief response are said, according to the Office of the day.');
	
	head('De oratione','The Collect',2);
	rubp('<snr>39</s> Expleto responsorio brevi, statim dicitur:', '<snr>39</s> After the brief response, the following is said immediately:');
	vr('dv_de_LV.php');
	vr('oremus.php');
	...
	rubp('<snr>40</s> Post ultimam orationem additur:', '<snr>40</s> After the last prayer is added:');
	vr('dv_de_short.php');
