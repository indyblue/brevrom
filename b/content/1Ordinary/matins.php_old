<?php
	...
	space('PgB');
	space();
	rubp('1. Officium divinum, nisi aliter suo loco indicetur, per totum annum et ad omnes Horas, absolvitur juxta formam, quæ in rubricis hujus Ordinarii exhibetur.',
...
/*
	...
	rubp('Dominica, a die 14 Jan usque Septuagesimam, et a die 1 Oct usque ad diem 26 Nov inclusive:',
		'Sunday, from 14 Jan through Septuagesima, and 1 Oct through 26 Nov, inclusive:',0);
	ant('Inv1Winter.php','+');
	rubp('Dominica, post Pentecosten usque ad diem 30 Sept.',
		'Sunday, after Pentecost until 30 Sept, inclusive.',0);
	ant('Inv1Summer.php','+');
