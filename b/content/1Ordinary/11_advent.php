...
//	rubp('In Officio tam dominicali quam feriali, dicitur sequens hymnus et versus:','In both the Sunday and ferial Office, the following hymn and verse is said:');
	...
	rubp('Preces (<snr>p. '. bkref('preces') .'</s>) dicuntur: in Laudibus feriæ IV et VI temporis Adventus, et in Laudibus sabbatorum Quatuor Temporum.',
		'The preces (<snr>p. '. bkref('preces') .'</s>) are said: in Lauds of Wed. and Fri. in the season of Advent, and in Lauds of Ember Saturday.');
...
/*
	...
	rubp('In Officio tam dominicali quam feriali, excepta vigilia Nativitatis Domini, dicitur cotidie sequens:',
		'In both the Sunday and ferial Office, except the vigil of the Nativity of our Lord, every day is said the following:');
*/
	...
	head('Preces','Preces',3);
	rubp('Preces (<snr>p. '. bkref('preces') .'</s>) dicuntur: in Vesperis feriæ IV et VI temporis Adventus.',
		'The preces (<snr>p. '. bkref('preces') .'</s>) are said: in Vespers of Wed. and Fri. in the season of Advent.');
