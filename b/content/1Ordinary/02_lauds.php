<?php
	...
	bookmark('orLauds');
	hour('L','O');
	rubp('<snr>12</s> Laudes absolute incipiuntur versu:', '<snr>12</s> Lauds always begins with this verse:');
	...
	rubp('<snr>14</s> Repetita antiphona post ultimum psalmum, dicitur capitulum, hymnus et versus, prouti Officium occurrens requirit. In fine omnium capitulorum respondetur:', '<snr>14</s> After Repeating the antiphon after the last psalm, recite the little chapter, hymn and versicle, according to the Office of the day. At the end of all little chapters the response is:');
	vr('deo_gratias.php');

	head('De cantico <snr>Benedíctus</s>','The canticle <snr>Benedíctus</s>',2);
	rubp('<snr>15</s> Recitato versu, dicitur cum antiphona convenienti sequens:', '<snr>15</s> After reciting the versicle, recite, with the proper antiphon, the following:');
	bookmark('benedictus');
	canticle('benedictus.php');
	reading('vr/gloria_patri-s.php',0);

	head('De precibus','The Preces, or Prayers',2);
	rubp('<snr>16</s> Quando, juxta rubricas (n. 260), preces sunt dicendæ post repetitam antiphonam ad <snr>Benedíctus</s>, dicitur, flexis genibus.', '<snr>16</s> When, according to the rubrics (n. 260), the preces are to be said, after the antiphon at the <snr>Benedíctus</s> is repeated , say the Preces, while kneeling.');
	...
	rubp('<snr>17</s> Expleto cantico et repetita antiphona, si preces non fuerint recitandæ, statim dicitur:', '<snr>17</s> After the <snr>Benedíctus</s> and the antiphon is repeated, if the preces are not to be recited, the following is said immediately:');
	vr('dv_de_LV.php');
	vr('oremus.php');
	...
	rubp('<snr>18</s> Post ultimam orationem additur:', '<snr>18</s> After the last prayer is added:');
	vr('dv_de_short.php');
