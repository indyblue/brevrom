...
<p:P179/>
   ...
   <table>
    <tr>
     ...
     <td:B1>
      <p:BodyEDrop>OUR Father, Who art in heaven, Hallowed be Thy Name. Thy kingdom come. Thy will be done on earth, as it is in heaven. Give us this day our daily bread. And forgive us our trespasses, as we forgive those who trespass against us. And lead us not into temptation; but deliver us from evil. Amen.</p>
     </td>
    </tr>
    <tr>
     <td:A1>
...
<?php vr('domine_exaudi.php',1); ?>
   ...
   <p:RubricH>To a Prayer addressed to God the Father, which makes mention of God the Son in the final clause:</p>
   <table>
    <tr>
     <td:A1>
   ...
   <p:RubricH>To a Prayer addressed to God the Son:</p>
   <table>
    <tr>
     <td:A1>
   ...
   <table>
    <tr>
     <td:A1>
      <p:BodyLIndent>Laus tibi Dómine, Rex ætérnæ glóriæ.</p>
     </td>
     <td:B1>
      <p:BodyEIndent>Praise be to thee, O Lord, King of eternal glory.</p>
     </td>
    </tr>
   </table>
   <p:Spacer/>
