...
include 'dayhour.php';
	...
	psalm(28);
	canticle('david.php');
	head('Psalmus 116','Psalm 116','2Ps'); //psalm(116,0,1);
	...
	head('Psalmus 18','Psalm 18','2Ps'); //psalm(18,1);
	//psalm(18,2);

	dayhoursup(2,'T');
  head('Psalmus 26 OD Mat N2','','2Ps'); 
	psalm(26,1);
	psalm(26,2);
	psalm(27);
	...
	head('Psalmus 121','Psalm 121','2Ps'); //psalm(121,0,1);
