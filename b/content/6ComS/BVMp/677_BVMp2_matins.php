...
'After which is said the Verse <snr>Grace is poured</s> and following, as below on <snr>p. '.bkref('csBVMpML1').'</s>, when only one Nocturn is said.');
	...
	bookmark('csBVMpMn3');
		...
		psalm(96);
		space('Spacer');
		ant('opBVMm.php','00000001-2');
		psalm(97);
		space('Spacer');
		ant('opBVMm.php','00000000-1');
	}
  ...
  if($htm) rubp('<snr>Te Deum</s>, si dicitur, ut infra <snr>p. '.bkref('csBVMpTD').'</s>',
		'<snr>Te Deum</s>, if said, as below on <snr>p. '.bkref('csBVMpTD').'</s>');
