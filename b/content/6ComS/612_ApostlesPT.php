...
<?php rubrics('asIn.php','csMLh','Lauds, Common of One Martyr','For One Martyr, Hymn <s:NonRubric>Invícte Martyr, únicum</s>'); ?>
<?php rubrics('asIn.php','csMmLh','Lauds, Common of Several Martyrs','For Several Martyrs, Hymn <s:NonRubric>Rex glorióse Mártyrum</s>'); ?>
...
<?php lc('wis5_1.php'); ?>
<?php rubrics('head/HymnVerse.php'); ?>
<?php rubrics('asIn.php','csMVh','Vespers, Common of One Martyr','For One Martyr, Hymn <s:NonRubric>Deus, tuórum mílitum</s>'); ?>
<?php rubrics('asIn.php','csMmLh','Lauds, Common of Several Martyrs','For Several Martyrs, Hymn <s:NonRubric>Rex glorióse Mártyrum</s>'); ?>
   <p:RubricH>For Apostles:</p>
