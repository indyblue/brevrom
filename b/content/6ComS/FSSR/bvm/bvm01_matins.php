...
rubp('Postea dicitur Versus <snr>Diffùsa est</s> et Lectiones, ut infra <snr>p. '.bkref('csBVMpML1').'</s>.', 
	'After which is said the Verse <snr>Grace is poured</s> and the Lessons, as below on <snr>p. '.bkref('csBVMpML1').'</s>, when only one Nocturn is said.');
