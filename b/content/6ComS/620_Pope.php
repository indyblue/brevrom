<?php
	...
	prayer('csPope2r.php');
	rubp('Si vero agenda sit commemoratio alterius Summi Pontificis, dicitur sequens.','If a commemoration of another Supreme Pontiff is made, the following is said.');
	prayer('csPope3r.php');
?>
